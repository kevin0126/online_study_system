    ...
    <div class="w-25" style="position: relative;">
        <div class="toast ml-auto" role="alert" data-delay="2000" style="position: absolute; bottom: 0; right: 0;" data-autohide="true">
            <div class="toast-body alert-success">
                Student Record <strong class="successID">xxxxxxx</strong> Save Succesfully
            </div>
        </div>
    </div>
</div>
...
<div class="container" id="mainCard">
    ...
    <h1><strong>New Student Record</strong></h1>
    ...
    @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" value="" name="studName" class="form-control" id="studName">
        ...
        <div class="form-group">
            ...
            <input type="email" value="" name="email" class="form-control" id="email" placeholder="exp: D190030B@sc.edu.my">
