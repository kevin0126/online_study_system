        ...
        <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
          ...
          <div class="multisteps-form__content">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $classDetails->classID }}" name="classID" class="form-control" id="classID" readonly>
            </div>

            <div class="form-group">
                <label for="success" class="control-label">Class Code</label>
                <input type="text" value="{{ $classDetails->classCode }}" name="classCode" class="form-control" id="classCode">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $classDetails->className }}" name="className" class="form-control" id="className">
            ...
            <div class="form-group">
                ...
                @foreach($facultys as $faculty)
                    @if($faculty->id == $classDetails->facultyID)
            ...
            <div class="form-group">
                ...
                @foreach($lecturers as $lecturer)
                    @if($lecturer->id == $classDetails->teacherID)
                        <option value='{{ $lecturer->idCode }}' selected>{{ $lecturer->name }}</option>
                    @else
        ...
        <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
          ...
          <div class="multisteps-form__content">
            ...
            <div class="button-row d-flex mt-4" id="comfirmPanel">
                <button class="btn btn-primary js-btn-prev col-md-2" type="button" title="Prev">Prev</button>
                <button class="btn btn-success ml-auto offset-8 col-md-2" type="button" id="btnSetup" >Setup</button>
            </div>
          </div>
        </div>
      </form>
...
$('.studFooter').on('click','#btnErollStud',function(e){
    ...
    $.ajax({
        ...
        success: function (data){
            ...
            if(data.length > 0){
                var checkID = (element) => element.id === data[0]['id'];
...
function comfirmEnroll(){
    $.each(tempErollArray, function(index, value){
        $('#enrollStudents_comfirm tbody').append("<tr><td>"+value['id']+"</td><td>"+value['name']+"</td><td>"+value['batch']+"</td></tr>");
    });
...
$('#comfirmPanel').on('click','#btnSetup',function(e){
    e.preventDefault();
