...
<div class="container" id="mainCard">
    ...
    <h1><strong>Edit Lecturer Record</strong></h1>
    ...
    @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ $lecturer[0]->idCode }}" name="lectID" class="form-control" id="lectID" readonly>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ $lecturer[0]->name }}" name="lectName" class="form-control" id="lectName">
        ...
        <div class="form-group">
            ...
            <input type="email" value="{{ $lecturer[0]->email }}" name="email" class="form-control" id="email">
